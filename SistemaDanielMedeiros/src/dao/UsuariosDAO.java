...
public class UsuariosDAO extends AbstractDAO {
    ...
    public DhmUsuarios login(String apelido, String senha) {
        session.beginTransaction();

        Criteria criteria = session.createCriteria(DhmUsuarios.class);
        criteria.add(Restrictions.eq("dhmApelido", apelido));
        criteria.add(Restrictions.eq("dhmSenha", senha));
        DhmUsuarios usuario = (DhmUsuarios) criteria.uniqueResult();
