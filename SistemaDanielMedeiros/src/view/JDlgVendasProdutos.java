...
public class JDlgVendasProdutos extends javax.swing.JDialog {
    ...
    public JDlgVendasProdutos(java.awt.Frame parent, boolean modal) {
        ...
        for (Object object : lista) {
            jCboProdutos.addItem((DhmProdutos) object);
        }
    ...
    private void initComponents() {
        ...
        jCboProdutos = new javax.swing.JComboBox<DhmProdutos>();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DhmVendasProdutos vendasProdutos = new DhmVendasProdutos();
        vendasProdutos.setDhmProdutos((DhmProdutos) jCboProdutos.getSelectedItem());
    ...
    private void jCboProdutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCboProdutosActionPerformed
        // TODO add your handling code here:
          DhmProdutos produtos = (DhmProdutos) jCboProdutos.getSelectedItem();
        jTxtValorUni.setText(Util.doubleToStr(produtos.getDhmPreco()));
        int quant = Util.strToInt(jTxtQuantidade.getText());
        jTxtTotal.setText(Util.doubleToStr(quant * produtos.getDhmPreco()));
   ...
   if (jTxtQuantidade.getText().isEmpty() == false) {
    ...
    private javax.swing.JComboBox<DhmProdutos> jCboProdutos;
